<footer class="clearfix">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 ftr_add_a wow fadeInDown"           data-wow-duration="0.5s"
                data-wow-delay="0.3s">
                <ul>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        ...
                        <ul id="menu-footer_menu" class="menu">
                            <li id="menu-item-135"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-5 current_page_item menu-item-135 active ">
                            ...
                            <li id="menu-item-190"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-190"><a
                                    href="department.php">Dpartment</a></li>
                            <li id="menu-item-190"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-190"><a
        ...
        <div class="copyrightsec" style="background:white;">
            <div class="container-fluid">
                <div class="row">
                    <p class="col-md-8 wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.7s">2023 ORGAN
                        HOSPITAL. All rights reserved | Designed by <a href="https://www.lpswebtechnology.com/"
                            target="_blank">LPS WEB TECHNOLOGY.</a>.</p>
