    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 margin-bottom-20 wow fadeInUp animated">
                <h2 class="title-7">OUR GALLERY Images</h2>
            </div>    
                
                <div class="col-md-3 col-sm-4 col-xs-12 margin-bottom-20 wow fadeInUp animated">
                    <a data-fancybox="gallery" href=""><img src="images/g1.jpg"></a>
                </div>

                
                <div class="col-md-3 col-sm-4 col-xs-12 margin-bottom-20 wow fadeInUp animated">
                    <a data-fancybox="gallery" href=""><img src="images/g2.jpg"></a>
                </div>

                
                <div class="col-md-3 col-sm-4 col-xs-12 margin-bottom-20 wow fadeInUp animated">
                    <a data-fancybox="gallery" href=""><img src="images/g3.jpg"></a>
                </div>

                
                <div class="col-md-3 col-sm-4 col-xs-12 margin-bottom-20 wow fadeInUp animated">
                    <a data-fancybox="gallery" href=""><img src="images/g4.jpg"></a>
                </div>

                
                <div class="col-md-3 col-sm-4 col-xs-12 margin-bottom-20 wow fadeInUp animated">
                    <a data-fancybox="gallery" href=""><img src="images/g5.jpg"></a>
                </div>

                
            <div class="col-md-12 col-sm-12 col-xs-12 margin-bottom-20 wow fadeInUp animated">
                <h2 class="title-7">OUR GALLERY Vedio</h2>
            </div>

                        <div class="col-md-3 col-sm-4 col-xs-12 margin-bottom-20 wow fadeInUp animated">
                <div class="video_part">
                 <iframe width="273" height="290" src="https://www.youtube.com/embed/Eeg78mgESOM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>             
                </div>
            </div>
                        <div class="col-md-3 col-sm-4 col-xs-12 margin-bottom-20 wow fadeInUp animated">
                <div class="video_part">
                 <iframe width="273" height="290" src="https://www.youtube.com/embed/kE9xFFVCUV8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>             
                </div>
            </div>
