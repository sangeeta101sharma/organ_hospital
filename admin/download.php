                            ...
                            <div class="card">
                                ...
                                <?php if(isset($_SESSION['msg']) && !empty($_SESSION['msg'])){?>
                                    ...
                                    <div class="live-preview">
                                        <form action="process/download.php" enctype="multipart/form-data"
                                            method="POST">
                                            <div class="row">
                                            <div class="col-md-12">
                                                    <div class="mb-3">
...
?>
                                                    ...
                                                    <td scope="row">
                                                        ...
                                                        <td class="customer_name"><a href="process/<?php echo $row['file'];?>" target="_blank"><img src="process/<?php echo $row['file'];?>" style="width:50px;height:50px;border-radius:50px;" alt=""></a>  </td>
