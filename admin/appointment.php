                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">VIEW APPOINTMENT FORM DETAILS</h4>
                                </div><!-- end card header -->
                                    ...
                                    <div class="listjs-table" id="customerList">
                                        ...
                                        <div class="table-responsive table-card mt-3 mb-1">
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                ...
                                                <?php 
                                                    $sql= "SELECT * FROM appointment_form_tbl";
                                                    ...
                                                    <td scope="row">
                                                        ...
                                                        <td class="customer_name"><?php echo $row['specialist'];?></td>
                                                        <td class="customer_name"> <?php echo $row['preferetime'];?></td>
                                                        <td class="customer_name"> <?php echo $row['preferedate'];?></td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                ...
                                                                <div class="remove">
                                                                    <a href="process/remove_appointmentform.php?id=<?php echo $row['id'];?>"  onclick="return confirm('Are you sure you want to delete?')";  class="btn btn-sm btn-danger remove-item-btn">Delete</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
