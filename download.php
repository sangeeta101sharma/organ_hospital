...
?>
    ...
    <div class="row" >
                        <div class="col-xl-10"  style="margin-left:120px;margin-top:50px;margin-bottom:50px;">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1" style="font-size:20px;text-align:center;padding-top:0;font-weight:bold;color:brown;">DOWNLOAD FILES</h4>
                                            ...
                                            <table class="table align-middle table-nowrap table-striped-columns mb-0">
                                                <thead class="table-light">
                                                    <tr style="border-bottom:3px solid black;">
                                                        ...
                                                        <th scope="col" style="color:navy;font-size:15px;font-weight:bold;">Sr.No.</th>
                                                        <th scope="col" style="color:navy;font-size:15px;font-weight:bold;"> File Name</th>
                                                        <th scope="col" style="color:navy;font-size:15px;font-weight:bold;">File</th>
                                                    </tr>
                                                </thead>
                                                <?php 
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><a href="#" class="fw-medium">   <?php echo $row['id'];?></a></td>
                                                        <td>   <?php echo $row['title'];?></td>
                                                        <td>
                                                            <a href="admin/process/<?php echo $row['file'];?>" target="_blank" download class="btn btn-sm btn-light"><i class="ri-download-2-fill"></i>Download</a>
                                                        </td>
                                                    </tr>
