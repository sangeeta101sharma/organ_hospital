...
<head>
    ...
    <link rel="alternate" type="application/json+oembed"
        href="wp-json/oembed/1.0/embed378b.json?url=https%3A%2F%2Forganhospital.com%2Fmedia%2F" />
        ...
        <div class="div-mtb">
            <div class="container">
                <div class="medical-services"
                    style="background-image: url('wp-content/uploads/2019/11/Medical-Services-a.jpg');">
                    <div class="medical-services-1">
                        <div class="medical-services-2">
                            <h2 class="title-3">Medical Department</h2>
                            <div class="nav-link-1">
                                <ul>
                                    ...
                                    <li>Nutrition and Dietary Services</li>
  ...
  <div class="row justify-content-center">
    <div class="col-lg-4 col-md-6 d-flex">
      <div class="blog-card w-100">
        ...
        <div class="description">
          ...
          <h2 class="pt-1 pb-4">: Also known as the Emergency Room, this department provides immediate medical care to patients with acute and life-threatening conditions.</h2>
          <p class="read-more">
    ...
    <div class="col-lg-4 col-md-6 d-flex">
      <div class="blog-card w-100">
        ...
        <div class="description">
          ...
          <h2 class="pt-1 pb-4">The ICU is where critically ill patients receive specialized care, often with advanced monitoring and life-support equipment.</h2>
          <p class="read-more">
            <a href="#" target="_blank">Click Here</a>
          </p>
        </div>
    ...
    <div class="col-lg-4 col-md-6 d-flex">
      <div class="blog-card w-100">
        ...
        <div class="description">
          ...
          <h2 class="pt-1 pb-4"> These units provide care for patients with a wide range of medical and surgical conditions, including post-operative care.</h2>
          <p class="read-more">
            <a href="#" target="_blank">Click Here</a>
          </p>
        </div>
    ...
    <div class="col-lg-4 col-md-6 d-flex">
      <div class="blog-card w-100">
        ...
        <div class="description">
          <h1>Pediatrics</h1>
          <h2 class="pt-1 pb-4"> Specialized care for infants, children, and adolescents is provided in the pediatric department.</h2>
          <p class="read-more">
            <a href="#" target="_blank">Click Here</a>
          </p>
        </div>
    ...
    <div class="col-lg-4 col-md-6 d-flex">
      <div class="blog-card w-100">
        ...
        <div class="description">
          <h1>Neurology</h1>
          <h2 class="pt-1 pb-4"> Neurology departments focus on the diagnosis and treatment of neurological disorders such as epilepsy, stroke, and multiple sclerosis.</h2>
          <p class="read-more">
            <a href="#" target="_blank">Click Here</a>
          </p>
        </div>
    ...
    <div class="col-lg-4 col-md-6 d-flex">
      <div class="blog-card w-100">
        ...
        <div class="description">
          <h1>Radiology</h1>
          <h2 class="pt-1 pb-4"> Radiology departments perform various imaging tests such as X-rays, CT scans, and MRIs.</h2>
          <p class="read-more">
            <a href="#" target="_blank">Click Here</a>
          </p>
        </div>
    ...
    <div class="col-lg-4 col-md-6 d-flex">
      <div class="blog-card w-100">
        ...
        <div class="description">
          <h1>Pharmacy </h1>
          <h2 class="pt-1 pb-4"> Hospitals have on-site pharmacies to dispense medications prescribed by physicians.</h2>
          <p class="read-more">
            <a href="#" target="_blank">Click Here</a>
          </p>
        </div>
    ...
    <div class="col-lg-4 col-md-6 d-flex">
      <div class="blog-card w-100">
        ...
        <div class="description">
          ...
          <h2 class="pt-1 pb-4"> Respiratory therapists assist patients with breathing difficulties, such as asthma or those on ventilators.
    ...
    <div class="col-lg-4 col-md-6 d-flex">
      <div class="blog-card w-100">
        ...
        <div class="description">
          ...
          <h2 class="pt-1 pb-4"> This department focuses on preventing and controlling hospital-acquired infections.</h2>
          <p class="read-more">
            <a href="#" target="_blank">Click Here</a>
          </p>
        </div>
