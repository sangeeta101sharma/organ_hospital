...
<body class="home page-template-default page page-id-5">
    ...
    <section class="specialitiesesec">

        <div class="container-fluid">

            <div class="row">

                <div class="col-md-10 offset-md-1 col-sm-12 offset-sm-0 col-xs-12 offset-xs-0 special_heading">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7 ">
                            ...
                            <p>Our Hospital was set up with a holistic approach towards patient care based on ethics,
                                quality care and professionalism backed by affordability.</p>
                ...
                <div class="col-md-12 speciality_carousel_outer">

                    <div class="row">

                        <div class="specialitycarousel owl-carousel owl-theme">

                            <div class="item wow zoomIn" data-wow-duration="0.8s" data-wow-delay="0.4s">

                                <img alt="Young Girl holding her knee due to intense pain and problem"
                                    src="images/Operation_Theatre.jpg" width="1595" height="200" class="img-fluid" />

                                <div class="spec_caption">
                            ...
                            <div class="item wow zoomIn" data-wow-duration="0.8s" data-wow-delay="0.4s">
                                ...
                                <img alt="Doctor holding a miniature of heart, for cardiology care"
                                    src="images/Ultrasound.jpg" width="1595" height="200" class="img-fluid" />
                            ...
                            <div class="item wow zoomIn" data-wow-duration="0.8s" data-wow-delay="0.4s">
                                ...
                                <img alt="Pregnant Woman speaking to Gynecologist regarding her maternity"
                                    src="images/Pathology.jpg" width="1595" height="200" class="img-fluid" />
                            ...
                            <div class="item wow zoomIn" data-wow-duration="0.8s" data-wow-delay="0.4s">
                                ...
                                <img alt="child care specialist" src="images/Digital_X-Ray.webp" width="1595"
